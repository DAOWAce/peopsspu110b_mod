...
void ReadConfig(void)
{
	FILE *fp;
	int reset;
    char ini_version[256] = {0};
	
	reset = 1;

	fp = _fsopen("inis\\spuPeopsSound.ini", "r", _SH_DENYNO );
	if( !fp ) fp = _fsopen("plugins\\spuPeopsSound.ini", "r", _SH_DENYNO );
	...
	if( reset ) {
        ...
        fp = _fsopen("inis\\spuPeopsSound.ini", "w", _SH_DENYNO );
		if( !fp ) fp = _fsopen("plugins\\spuPeopsSound.ini", "w", _SH_DENYNO );
	...
	fp = _fsopen("inis\\spuPeopsSound_expert.ini", "r", _SH_DENYNO );
	if( !fp ) fp = _fsopen("plugins\\spuPeopsSound_expert.ini", "r", _SH_DENYNO );
	...
	if( reset ) {
		// Defaults
        fp = _fsopen("inis\\spuPeopsSound_expert.ini", "w", _SH_DENYNO );
		if( !fp ) fp = _fsopen("plugins\\spuPeopsSound_expert.ini", "w", _SH_DENYNO );
